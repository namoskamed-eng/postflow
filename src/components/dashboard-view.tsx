...
import { AlertTriangle, Bell, CalendarCheck, CalendarClock, Play, Plus, Sunrise } from "lucide-react";
...
export function DashboardView({ posts, clients, onOpen, onNew, onCalendar, onPublication }: { posts: Post[]; clients: Client[]; onOpen: (post: Post) => void; onNew: () => void; onCalendar: () => void; onPublication: () => void }) {
